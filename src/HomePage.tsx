...
import Image1 from "../src/assets/illustration_1.png";
import Image2 from "../src/assets/illustration_2.png";
import Image3 from "../src/assets/illustration_3.png";
    ...
    <Container>
      ...
      <div>
        <MouseParallax enableOnTouchDevice strength={0.02} shouldResetPosition>
          ...
          >
            <img src={Image1} width={600} height={450} alt="Illustration 1" />
          </div>
        </MouseParallax>
        <MouseParallax enableOnTouchDevice strength={0.04}>
          <div style={{ top: "-40px", left: "500px", position: "absolute" }}>
            <img src={Image2} width={290} height={200} alt="Illustration 2" />
          </div>
        </MouseParallax>
        <Title
          style={{
